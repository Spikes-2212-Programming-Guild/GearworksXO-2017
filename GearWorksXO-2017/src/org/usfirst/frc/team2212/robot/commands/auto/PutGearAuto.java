...
public class PutGearAuto extends CommandGroup {
	...
	public static final Supplier<Double> DRIVE_SPEED_START = ConstantHandler.addConstantDouble("putGearAuto- start driving speed",
			0.3);
	...
	public static final Supplier<Double> DRIVE_TO_GEAR_SPEED = ConstantHandler.addConstantDouble("putGearAuto - drive speed to gear", 0.5);
	public static final Supplier<Double> DRIVE_TO_GEAR_TIME = ConstantHandler.addConstantDouble("putGearAuto - drive time to gear", 0.5);
